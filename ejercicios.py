...
EJERCICIOS = [
    ...
    },
    {
        ...
        "codigo": [
            ...
            {"texto": "",                                            "tipo": "vacio",      "delay": 100,  "log": None},
            {"texto": "# Obtener Top-3 predicciones",               "tipo": "comentario", "delay": 400,  "log": None},
            {"texto": "top3 = torch.topk(probs, 3)",                "tipo": "codigo",     "delay": 500,  "log": None, "accion": "mostrar"},
            {"texto": "for i in range(3):",                          "tipo": "codigo",     "delay": 300,  "log": None},
